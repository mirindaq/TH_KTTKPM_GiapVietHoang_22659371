...
public class ProductServiceImpl implements ProductService {
    ...
    // Bật = true để giả lập lỗi, test circuit breaker
    public static volatile boolean fakeFail = false;
    ...
    public Product getById(Long id) {
        if (fakeFail) {
            throw new RuntimeException("[FAKE] Product-service simulated failure");
        }
